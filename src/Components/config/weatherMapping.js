...
var weatherMapping = {
    cloudyDay: [cloudyDay1, cloudyDay2, cloudyDay3],
    cloudyNight: [cloudyNight1, cloudyNight2, cloudyNight3],
    rainyDay: [rainy1, rainy2, rainy3],
    rainyNight: [rainy4, rainy5, rainy6, rainy7],
    snowyDay: [snowy1, snowy2, snowy3],
    snowyNight: [snowy4, snowy5, snowy6],
    cloudy: cloudy,
    day: day,
    night: night,
    thunder: thunder
